...
各コンポーネントが何をしているかの詳細は [docs/DESIGN.ja.md](docs/DESIGN.ja.md) を参照してください。
...
| | |
|---|---|
| [docs/DESIGN.ja.md](docs/DESIGN.ja.md) | 各コンポーネントの役割、なぜ mediamtx と nginx の2つだけなのか、遅延と安定性を分離した理由、HLS の遅延が消えない理由、用語集 |
| [docs/OPERATIONS.ja.md](docs/OPERATIONS.ja.md) | 動いているかの確認手順、直らないときに何から見るか |
| [docs/CONFIGURATION.ja.md](docs/CONFIGURATION.ja.md) | 触れる設定の一覧、変更時の落とし穴、構成ファイルの中身 |
| [docs/DEAD-ENDS.ja.md](docs/DEAD-ENDS.ja.md) | 検討して採用しなかった選択肢とその理由 |
